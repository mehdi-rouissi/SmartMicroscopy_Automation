...
fichiers = {
    'X': (profil_folder + 'profil_X.csv', scale_x),
    'Y': (profil_folder + 'profil_Y.csv', scale_y),
    'Z': (profil_folder + 'profil_Z.csv', scale_z)
}
...
output_path = os.path.join(output_folder, "FWHM1D_psf_results.txt")
...
plt.tight_layout()
plt.savefig(output_folder + "fit1D_psf.png")
plt.close()
